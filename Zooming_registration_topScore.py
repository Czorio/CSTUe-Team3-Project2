...
ZoomedAtlas = zooming(atlas)
ZoomedPatient = zooming(patient)

ZoomedresultImage, ZoomedresultManuals, ZoomedresultScore = register(ZoomedAtlas, ZoomedPatient)

#%%
resultSc, resultIm, resultMn = selectResults(resultImage, resultManuals, resultScore)
ZoomedresultSc, ZoomedresultIm, ZoomedresultMn = selectResults(ZoomedresultImage, ZoomedresultManuals, ZoomedresultScore)